...
To start up the cluster, use:
    ...
    make all
as well as commands from sections 6.2 and 6.3 to create secrets and argocd. Once argocd is up, and secrets are in place you can synchronise the app and it should be running.
